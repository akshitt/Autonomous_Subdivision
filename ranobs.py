...
def avoid_obs():
	...
	curr_cord_left = [curr_cord[0]-2,curr_cord[1]+2]
	curr_cord_right = [curr_cord[0]+2,curr_cord[1]-2]
...
while(la.norm(curr_cord-fin_cord)>5):
	...
	elif(np.min(dist_obs)>50 and curr_cord[0]!=curr_cord[1]):
